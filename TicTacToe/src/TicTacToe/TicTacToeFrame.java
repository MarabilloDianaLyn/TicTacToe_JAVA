...
public class TicTacToeFrame extends javax.swing.JFrame {
    ...
    private void winningGame(){
        ...
        if(b1==("X") && b2==("X") && b3==("X")){
            ...
            xCount++;
            gameScore();
            jButton1.setBackground(Color.getHSBColor(69, 82, 81));
            jButton2.setBackground(Color.getHSBColor(69, 82, 81));
            jButton3.setBackground(Color.getHSBColor(69, 82, 81));
        }
        else if(b4==("X") && b5==("X") && b6==("X")){
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
            xCount++;
            gameScore();
            jButton4.setBackground(Color.getHSBColor(69, 82, 81));
            jButton5.setBackground(Color.getHSBColor(69, 82, 81));
            jButton6.setBackground(Color.getHSBColor(69, 82, 81));
        }
        else if(b7==("X") && b8==("X") && b9==("X")){
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
            xCount++;
            gameScore();
            jButton7.setBackground(Color.getHSBColor(69, 82, 81));
            jButton8.setBackground(Color.getHSBColor(69, 82, 81));
            jButton9.setBackground(Color.getHSBColor(69, 82, 81));
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tic Tac Fcking Toe");
        ...
        jLabelPlayerX.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabelPlayerX.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel7.add(jLabelPlayerX, java.awt.BorderLayout.CENTER);
        ...
        jLabelPlayerO.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabelPlayerO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel12.add(jLabelPlayerO, java.awt.BorderLayout.CENTER);
